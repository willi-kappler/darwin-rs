...
fn main() {
    ...
    if options.server {
        ...
        let mut server = SimulationServer::new(tsp3, options.population, options.limit);
        ...
        let mut node = SimulationNode::new(tsp3, options.population);
